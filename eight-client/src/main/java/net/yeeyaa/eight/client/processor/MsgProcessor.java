...
public class MsgProcessor implements IProcessor<ClientMsg, ClientMsg>{
	...
	protected IProcessor<DefaultError, DefaultError> error;
	...
	public void setError(IProcessor<DefaultError, DefaultError> error) {
		this.error = error;
	}
