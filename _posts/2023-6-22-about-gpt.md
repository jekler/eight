...
回忆一下[第一章](similar-concepts)这张关于经验主义形成共识的图，GPT的奥秘就在这里：
...
其实这个问题并不困难，看我们上面那张图，如果将里面任意一个similar-concepts (sc)，用一个词表达，这就是这个词的本质——词的本质在于它并无本质，它的意义随使用者的经验而存在。所以语言的问题，并不在它本身，而在于它的使用者，在于人身上。`语言本质上是人对经验共性的表达`{:.success}。
