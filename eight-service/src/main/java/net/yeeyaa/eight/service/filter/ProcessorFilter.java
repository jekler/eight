...
public class ProcessorFilter implements IProcessor<Object, Object>{
	...
	protected Boolean ignoreError;//true for try catch, false for none, null for throw error but peform
	...
	public Object process(Object msg) {
		if (ignoreError  == null) try {
			if(in != null) msg = in.process(msg);//ForkXProcessor + common Processor
		} finally {
			try {
