...
public class CloseProcessor implements IProcessor<Object, Object> {
	...
	protected Object paras; //default paras when close
	...
	public void destroy(){//may be use for destroy
		process(null);
	}
	...
	public class Close implements IProcessor<Object, Object>{//sub processor list thread. handles converting various outer class-->callback processor-->(outer class : inner closer) entry into close center. so, a close center can do with multiple closers.
		protected IProcessor<Object, IProcessor<Void, Void>> closer; //commonly callback processor + closer inner class factory
		protected Object paras; //paras when close
