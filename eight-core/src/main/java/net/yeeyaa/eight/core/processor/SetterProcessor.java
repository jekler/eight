...
public class SetterProcessor implements IProcessor<Object, Object>{
	...
	public class SetInstance implements IProcessor<Object, SetterProcessor>{//singleton: MultiParas + chian[beanHolder-->SetInstance]-->chain[Setter-->next SetInstance]-->...-->last Setter
		@Override //self setter: chian[beanHolder-[Setter]->callback-[other Setter(ref(setInstance=Setter))]]-->set Any thing-->A new Setter
		public SetterProcessor process(Object instance) {//prototype:MultiInvoke + chain[beanHolder-->SetInstance-->callback-->chain[[ref(Setter)-->next SetInstance-->deeper callback-->...-->last SetInstance]]]
