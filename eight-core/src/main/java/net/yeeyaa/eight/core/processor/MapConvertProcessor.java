...
public class MapConvertProcessor implements IProcessor<Map<Object, Object>, Map<Object, Object>>{
	...
	public Map<Object, Object> process(Map<Object, Object> instance) {
		if(instance != null && instance.size() > 1) for (Entry<Object, Object> entry : instance.entrySet()) if (matchers != null && matchers.containsKey(entry.getKey())) entry.setValue(matchers.get(entry.getKey()).process(entry.getValue()));
