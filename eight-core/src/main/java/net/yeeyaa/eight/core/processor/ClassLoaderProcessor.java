...
public class ClassLoaderProcessor extends ClassLoader implements IProcessor<String, Class<?>> {//this + CommonUtil.getCallerClassLoader(int) + ClassAppendProcessor = dynamic classloader invoker
	protected final Logger log;
	protected ClassLoader classLoader; //CommonUtil.getDefaultClassLoader + cache=true;
