...
public class PlatformUniversal<K, V, U extends IListableResource<K, V>, T, R> implements IUniversal<K, V, U, T, R>{
	protected IProcessor<Object, Object> beanHolder; //PlatformUniversal + beanHolder + callback = another beanHolder
	protected Object bean;//PlatformUniversal + PlatformReference + null = proxy
