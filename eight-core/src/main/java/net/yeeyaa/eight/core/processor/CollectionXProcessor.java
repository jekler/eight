...
public class CollectionXProcessor implements IProcessor<Object, Object> {
	...
	protected IProcessor<Object, Collection<Object>> convertor;//splitter or something else
	protected Boolean type; //null : for collection, true : for map; false : for array
	protected Boolean adapt; //null: for adapt auto; true: for deep and adapt; false: for not adapt, do not index when this enable
