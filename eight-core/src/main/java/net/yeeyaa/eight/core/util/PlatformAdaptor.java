...
public class PlatformAdaptor extends URLConnection implements Comparator<Object[]>, IProcessor<Object[], Object>, IExtendable<Object> {
	...
	protected Map<String,List<String>> map; //platformBean.ReadonlyListable + resourcemap + this (type cast)= context with url
	...
	protected class Processor<T, R> implements IProcessor<T, R> {
		protected volatile int resume; //<0: never resume; 0: resume first; 1: resume to exist; 2:resume to adapt; 3: resume forever
