...
public class ArrayMergeProcessor implements IProcessor<Object, Object[]> {	
	...
	protected Boolean discard; //discard when seq lt then input length and discrad is true,  append and override all after the whole array when discrad is null, other wise append and override all after the largest index;
