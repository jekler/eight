...
public class RegexProcessor implements IProcessor<String, Object> {
	protected Pattern pattern; //match multi-head service(such as "project1@service1@method") pattern = *@([\w.$@]+) index = 1
	protected Integer index = 0;
	protected Boolean fetchAll = false;
	protected Boolean keepOrigin = false; //store name and return back origin string
