...
//StorageCopyProcessor + CollectionAtProcessor + StorageByteProcessor = IExtendable<Object> --> byte[] --> output resource
//above + WatchSGroup + CollectionXResource = watch and copy resource --> output resource
//WatchSGroup type=0(return all) + RresourceRemoveProcessor = any changes(add, remove, modify)
