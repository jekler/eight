...
public class FlaterStreamPool implements IProcessor<Object, Object>, IBiProcessor<Object, String, Object>, ITriProcessor<Object, String, Integer, Object>, Runnable, Comparator<Object[]> {	
    ...
    protected static final int FHCRC	= 2;	// Header CRC
    protected static final int FEXTRA	= 4;	// Extra field
    protected static final int FNAME	= 8;	// File name
    protected static final int FCOMMENT	= 16;	// File comment
	...
	protected static final int LOCHDR = 30;	// LOC header size
	protected static final int EXTHDR = 16;	// EXT header size
	protected static final int CENHDR = 46;	// CEN header size
	protected static final int ENDHDR = 22;	// END header size
	protected static final int LOCVER = 4;	// version needed to extract
	protected static final int LOCFLG = 6;	// general purpose bit flag
	protected static final int LOCHOW = 8;	// compression method
	protected static final int LOCTIM = 10;	// modification time
	protected static final int LOCCRC = 14;	// uncompressed file crc-32 value
	protected static final int LOCSIZ = 18;	// compressed size
	protected static final int LOCLEN = 22;	// uncompressed size
	protected static final int LOCNAM = 26;	// filename length
	protected static final int LOCEXT = 28;	// extra field length
	protected static final int EXTCRC = 4;	// uncompressed file crc-32 value
	protected static final int EXTSIZ = 8;	// compressed size
	protected static final int EXTLEN = 12;	// uncompressed size
	protected static final int CENVEM = 4;	// version made by
	protected static final int CENVER = 6;	// version needed to extract
	protected static final int CENFLG = 8;	// encrypt, decrypt flags
	protected static final int CENHOW = 10;	// compression method
	protected static final int CENTIM = 12;	// modification time
	protected static final int CENCRC = 16;	// uncompressed file crc-32 value
	protected static final int CENSIZ = 20;	// compressed size
	protected static final int CENLEN = 24;	// uncompressed size
	protected static final int CENNAM = 28;	// filename length
	protected static final int CENEXT = 30;	// extra field length
	protected static final int CENCOM = 32;	// comment length
	protected static final int CENDSK = 34;	// disk number start
	protected static final int CENATT = 36;	// internal file attributes
	protected static final int CENATX = 38;	// external file attributes
	protected static final int CENOFF = 42;	// LOC header offset
	protected static final int ENDSUB = 8;	// number of entries on this disk
	protected static final int ENDTOT = 10;	// total number of entries
	protected static final int ENDSIZ = 12;	// central directory size in bytes
	protected static final int ENDOFF = 16;	// offset of first CEN header
	protected static final int ENDCOM = 20;	// zip file comment length
	...
	protected Integer size = -1; //pool size: 0.1m per def, 0 for inf, default negative: no limit
	protected Mode mode = Mode.gzip; //0: gzip, 1: flate, 2: r-flate: 3: zip, 4: jar
	...
	@Override
	public void run() {//PlatformTask for schedule task
