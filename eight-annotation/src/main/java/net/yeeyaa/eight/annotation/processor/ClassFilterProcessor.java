...
public class ClassFilterProcessor implements IProcessor<Collection<Class<?>>, Collection<Class<?>>> {
	...
	protected Boolean strict;//null: non-mapping annotational class will put into default processor, true: no-mapping class will be discard. false: non-mapping annotational class and non-annotation class will put into default processor
	protected Boolean method;//null : do not filter method, true: filter method and put filter type to corresponsding set. false: if method and class filter are inconsistent, discard.
