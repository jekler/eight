...
//this + MemoryClassLoader + JaxbUtil -->new context generators
public class ContextCallbackProcessor implements IProcessor<String, String> {
	...
	protected IProcessor<String, Void> invoker; //JaxbUtil
	protected IProcessor<IExtendable<Object>, Void> indexSetter; //MemoryClassLoader.AddResource
