...
public class PlatformVariable<R> implements IProcessor<Object, Object>, IMetaBean, BeanNameAware {
	...
	public Object process(final Object instance) { //null: remove, empty array: get, processor: execute, one obj array: set. 
	...
	public PlatformVariable<R> newInstance(Object paras, int mode) {//mode 0: max adapt, 1: reverse adapt other: variable change
		PlatformVariable<R> local = new PlatformVariable<R>();
		local.resource = resource;
		local.key = key;
