...
public class Logic_BaseLexer extends Lexer {
    ...
    public final void mSPECIAL() throws RecognitionException {
        try {
            ...
            // BaseLexer.g:4:5: ( 'null' | 'true' | 'false' )
            int alt1=3;
            switch ( input.LA(1) ) {
            case 'n':
                {
    ...
    public final void mATOMID() throws RecognitionException {
        try {
            int _type = ATOMID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // BaseLexer.g:7:8: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // BaseLexer.g:7:10: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // BaseLexer.g:7:34: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mDOUBLE() throws RecognitionException {
        try {
            ...
            switch (alt5) {
                case 1 :
                    // BaseLexer.g:11:9: INT '.' ( INT )?
                    {
                    mINT(); 
                    match('.'); 
                    // BaseLexer.g:11:17: ( INT )?
                    int alt4=2;
    ...
    public final void mSTRING() throws RecognitionException {
        try {
            int _type = STRING;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // BaseLexer.g:16:5: ( '\"' ( ESC | ~ ( '\\\\' | '\"' ) )* '\"' )
            // BaseLexer.g:16:8: '\"' ( ESC | ~ ( '\\\\' | '\"' ) )* '\"'
            {
            match('\"'); 
            // BaseLexer.g:16:12: ( ESC | ~ ( '\\\\' | '\"' ) )*
            loop6:
            do {
                int alt6=3;
    ...
    public final void mESC() throws RecognitionException {
        try {
            // BaseLexer.g:22:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) )
            // BaseLexer.g:22:9: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
            {
            match('\\'); 
    ...
    public void mTokens() throws RecognitionException {
        // BaseLexer.g:1:8: ( SPECIAL | ATOMID | INT | DOUBLE | STRING | WS )
        int alt8=6;
        alt8 = dfa8.predict(input);
        switch (alt8) {
            case 1 :
                // BaseLexer.g:1:10: SPECIAL
                {
                mSPECIAL(); 
