...
//VoidProcessor(classname + Chain(SubClassProcessor + ByteClassProcessor))(init-method=initialize) = register class
public class ByteClassProcessor extends ClassLoader implements IProcessor<byte[], Class<?>>, IReadonlyListable<Object, Class<?>>, IBiProcessor<Object, Object, Object>, ITriProcessor<byte[], Object, Object, Class<?>>, Comparator<Object[]> {
    ...
    protected IBiProcessor<Object, Object, Object> beanHolder;//for some out of spring get into environment via classloader.
	...
	public class GetClass implements IProcessor<String, Class<?>>{//AddClass + GetClass = storage-->class
		@Override
