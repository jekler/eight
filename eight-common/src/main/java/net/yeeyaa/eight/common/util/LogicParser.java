...
public class LogicParser extends Parser {
    ...
    // $ANTLR start "stat"
    // G:\\usefuljars\\antlr\\Logic.g:10:1: stat returns [boolean value] : ( WS )* complexpr ( WS )* EOF ;
    public final boolean stat() throws RecognitionException {
        ...
        try {
            // G:\\usefuljars\\antlr\\Logic.g:10:30: ( ( WS )* complexpr ( WS )* EOF )
            // G:\\usefuljars\\antlr\\Logic.g:11:6: ( WS )* complexpr ( WS )* EOF
            {
            // G:\\usefuljars\\antlr\\Logic.g:11:6: ( WS )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // G:\\usefuljars\\antlr\\Logic.g:11:7: WS
            	    {
            ...
            // G:\\usefuljars\\antlr\\Logic.g:11:22: ( WS )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // G:\\usefuljars\\antlr\\Logic.g:11:23: WS
            	    {
    ...
    // G:\\usefuljars\\antlr\\Logic.g:15:1: atomexpr returns [boolean value] : e1= content ( WS )* op= ( '==' | '!=' | '>=' | '<=' | '>' | '<' ) ( WS )* e2= content ;
    public final boolean atomexpr() throws RecognitionException {
        ...
        try {
            // G:\\usefuljars\\antlr\\Logic.g:15:34: (e1= content ( WS )* op= ( '==' | '!=' | '>=' | '<=' | '>' | '<' ) ( WS )* e2= content )
            // G:\\usefuljars\\antlr\\Logic.g:16:8: e1= content ( WS )* op= ( '==' | '!=' | '>=' | '<=' | '>' | '<' ) ( WS )* e2= content
            {
            ...
            // G:\\usefuljars\\antlr\\Logic.g:16:19: ( WS )*
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // G:\\usefuljars\\antlr\\Logic.g:16:20: WS
            	    {
            ...
            // G:\\usefuljars\\antlr\\Logic.g:16:57: ( WS )*
            loop4:
            do {
                int alt4=2;
                ...
                switch (alt4) {
            	case 1 :
            	    // G:\\usefuljars\\antlr\\Logic.g:16:58: WS
            	    {
    ...
    // $ANTLR start "complexpr"
    // G:\\usefuljars\\antlr\\Logic.g:20:1: complexpr returns [boolean value] : ( atomexpr | notblank | blank ) ( ( WS )* '&' ( WS )* e= complexpr | ( WS )* '|' ( WS )* e= complexpr )? ;
    public final boolean complexpr() throws RecognitionException {
        ...
        try {
            // G:\\usefuljars\\antlr\\Logic.g:20:35: ( ( atomexpr | notblank | blank ) ( ( WS )* '&' ( WS )* e= complexpr | ( WS )* '|' ( WS )* e= complexpr )? )
            // G:\\usefuljars\\antlr\\Logic.g:21:7: ( atomexpr | notblank | blank ) ( ( WS )* '&' ( WS )* e= complexpr | ( WS )* '|' ( WS )* e= complexpr )?
            {
            // G:\\usefuljars\\antlr\\Logic.g:21:7: ( atomexpr | notblank | blank )
            int alt5=3;
            switch ( input.LA(1) ) {
            case SPECIAL:
            case ATOMID:
            ...
            switch (alt5) {
                case 1 :
                    // G:\\usefuljars\\antlr\\Logic.g:21:8: atomexpr
                    {
                    ...
                    break;
                case 2 :
                    // G:\\usefuljars\\antlr\\Logic.g:21:46: notblank
                    {
                    ...
                    break;
                case 3 :
                    // G:\\usefuljars\\antlr\\Logic.g:21:84: blank
                    {
            ...
            // G:\\usefuljars\\antlr\\Logic.g:21:114: ( ( WS )* '&' ( WS )* e= complexpr | ( WS )* '|' ( WS )* e= complexpr )?
            int alt10=3;
            alt10 = dfa10.predict(input);
            switch (alt10) {
                case 1 :
                    // G:\\usefuljars\\antlr\\Logic.g:22:8: ( WS )* '&' ( WS )* e= complexpr
                    {
                    // G:\\usefuljars\\antlr\\Logic.g:22:8: ( WS )*
                    loop6:
                    do {
                        int alt6=2;
                        ...
                        switch (alt6) {
                    	case 1 :
                    	    // G:\\usefuljars\\antlr\\Logic.g:22:9: WS
                    	    {
                    ...
                    // G:\\usefuljars\\antlr\\Logic.g:22:16: ( WS )*
                    loop7:
                    do {
                        int alt7=2;
                        ...
                        switch (alt7) {
                    	case 1 :
                    	    // G:\\usefuljars\\antlr\\Logic.g:22:17: WS
                    	    {
                    ...
                    break;
                case 2 :
                    // G:\\usefuljars\\antlr\\Logic.g:23:8: ( WS )* '|' ( WS )* e= complexpr
                    {
                    // G:\\usefuljars\\antlr\\Logic.g:23:8: ( WS )*
                    loop8:
                    do {
                        int alt8=2;
                        ...
                        switch (alt8) {
                    	case 1 :
                    	    // G:\\usefuljars\\antlr\\Logic.g:23:9: WS
                    	    {
                    ...
                    // G:\\usefuljars\\antlr\\Logic.g:23:16: ( WS )*
                    loop9:
                    do {
                        int alt9=2;
                        ...
                        switch (alt9) {
                    	case 1 :
                    	    // G:\\usefuljars\\antlr\\Logic.g:23:17: WS
                    	    {
    ...
    // $ANTLR start "notblank"
    // G:\\usefuljars\\antlr\\Logic.g:27:1: notblank returns [boolean value] : '!' ( WS )* blank ;
    public final boolean notblank() throws RecognitionException {
        ...
        try {
            // G:\\usefuljars\\antlr\\Logic.g:27:34: ( '!' ( WS )* blank )
            // G:\\usefuljars\\antlr\\Logic.g:28:7: '!' ( WS )* blank
            {
            match(input,19,FOLLOW_19_in_notblank252); 
            // G:\\usefuljars\\antlr\\Logic.g:28:10: ( WS )*
            loop11:
            do {
                int alt11=2;
                ...
                switch (alt11) {
            	case 1 :
            	    // G:\\usefuljars\\antlr\\Logic.g:28:11: WS
            	    {
    ...
    // $ANTLR start "blank"
    // G:\\usefuljars\\antlr\\Logic.g:32:1: blank returns [boolean value] : '(' ( WS )* complexpr ( WS )* ')' ;
    public final boolean blank() throws RecognitionException {
        ...
        try {
            // G:\\usefuljars\\antlr\\Logic.g:32:31: ( '(' ( WS )* complexpr ( WS )* ')' )
            // G:\\usefuljars\\antlr\\Logic.g:33:7: '(' ( WS )* complexpr ( WS )* ')'
            {
            match(input,20,FOLLOW_20_in_blank291); 
            // G:\\usefuljars\\antlr\\Logic.g:33:10: ( WS )*
            loop12:
            do {
                int alt12=2;
                ...
                switch (alt12) {
            	case 1 :
            	    // G:\\usefuljars\\antlr\\Logic.g:33:11: WS
            	    {
            ...
            value = complexpr6;
            // G:\\usefuljars\\antlr\\Logic.g:33:54: ( WS )*
            loop13:
            do {
                int alt13=2;
                ...
                switch (alt13) {
            	case 1 :
            	    // G:\\usefuljars\\antlr\\Logic.g:33:55: WS
            	    {
    ...
    // $ANTLR start "content"
    // G:\\usefuljars\\antlr\\Logic.g:36:1: content : ( INT | DOUBLE | STRING | SPECIAL | id );
    public final LogicParser.content_return content() throws RecognitionException {
        ...
        try {
            // G:\\usefuljars\\antlr\\Logic.g:36:9: ( INT | DOUBLE | STRING | SPECIAL | id )
            int alt14=5;
            switch ( input.LA(1) ) {
            case INT:
                {
            ...
            switch (alt14) {
                case 1 :
                    // G:\\usefuljars\\antlr\\Logic.g:36:11: INT
                    {
                    ...
                    break;
                case 2 :
                    // G:\\usefuljars\\antlr\\Logic.g:36:17: DOUBLE
                    {
                    ...
                    break;
                case 3 :
                    // G:\\usefuljars\\antlr\\Logic.g:36:26: STRING
                    {
                    ...
                    break;
                case 4 :
                    // G:\\usefuljars\\antlr\\Logic.g:36:35: SPECIAL
                    {
                    ...
                    break;
                case 5 :
                    // G:\\usefuljars\\antlr\\Logic.g:36:45: id
                    {
    ...
    // $ANTLR start "id"
    // G:\\usefuljars\\antlr\\Logic.g:38:1: id : ATOMID ( '.' ATOMID )* ;
    public final void id() throws RecognitionException {
        try {
            // G:\\usefuljars\\antlr\\Logic.g:38:4: ( ATOMID ( '.' ATOMID )* )
            // G:\\usefuljars\\antlr\\Logic.g:38:6: ATOMID ( '.' ATOMID )*
            {
            match(input,ATOMID,FOLLOW_ATOMID_in_id338); 
            // G:\\usefuljars\\antlr\\Logic.g:38:13: ( '.' ATOMID )*
            loop15:
            do {
                int alt15=2;
                ...
                switch (alt15) {
            	case 1 :
            	    // G:\\usefuljars\\antlr\\Logic.g:38:14: '.' ATOMID
            	    {
