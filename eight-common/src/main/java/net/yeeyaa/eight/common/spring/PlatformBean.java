...
public class PlatformBean implements ApplicationContextAware, ApplicationListener<ApplicationContextEvent>{
	...
	public class Begin implements IProcessor<Object, Object>{
		...
		protected Boolean repeat = false;//false: init = null do nothing init !=null startSignal and init only once | true: init = null only startSignal init != null  startSignal and init everytime
	...
	public class ReadonlyListable<T, R> implements IReadonlyListable<T, R>{
		protected Integer mode = 0; //0 getBean 1 getType 2 getVer 4 getVerType other: getVerBean
